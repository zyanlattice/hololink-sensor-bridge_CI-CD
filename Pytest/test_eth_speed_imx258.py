"""
Test suite for verify_eth_speed_imx258.py
...
def test_ethernet_throughput(hololink_device_ip, camera_mode, record_test_result):
    ...
    import verify_eth_speed_imx258
    import sys
    ...
    try:
        ...
        try:
            # verify_eth_speed_imx258.py returns (success, message, stats)
            success, message, stats = verify_eth_speed_imx258.main()
