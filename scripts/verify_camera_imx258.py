...
def verify_camera_functional(
    ...
    try:
        ...
        # Compute acceptable min_fps as 80% of expected (±20% tolerance)
        ...
        stats = {
            ...
            "fps_test_result": (test_result := "pass" if (frame_count >= frame_limit * 0.9 and avg_fps >= computed_min_fps) else "fail"),
        }
